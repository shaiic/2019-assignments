...
namespace App1
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            //StorageFile modeFile = await StorageFile.GetFileFromApplicationUriAsync(
              //                      new Uri("ms-appx:///Assets/bear.onnx"));
            //model = await bearModel.CreateFromStreamAsync(modeFile);
