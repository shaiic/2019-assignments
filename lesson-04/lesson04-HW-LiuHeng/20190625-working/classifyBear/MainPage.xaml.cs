    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void TbRecognize_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var softwareBitmap = await decoder.GetSoftwareBitmapAsync();//转化为bitmap

                // 构造模型需要的输入格式
                VideoFrame videoFrame = NewMethod(softwareBitmap);
        ...
        private static VideoFrame NewMethod(SoftwareBitmap softwareBitmap)
        {
