...
class HouseSingleDataProcessor(object):
    def PrepareData2(self, csv_file):
        self.X = None
        self.Y = None
        i = 0
        with open(csv_file, newline='') as f:
            ...
            for row in reader:
                ...
                array_x[0,5] = 1   # waterfront row[8]
    ...
    def PrepareData(self, csv_file):
        ...
        with open(csv_file, newline='') as f:
            ...
            for row in reader:
                ...
                array_x[0,3] = row[6]   # sqft lot
                array_x[0,4] = row[7]   # floors
                array_x[0,5] = row[10]   # condition
                array_x[0,6] = row[11]  # grade
                array_x[0,7] = row[12]  # sqft above
                array_x[0,8] = row[13]  # sqft base
                array_x[0,9] = row[14]  # year built
                if (int)(row[15]) != 0:
                    array_x[0,9] = (int)(row[15])
                #array_x[0,11] = row[15]  # year renovate
                array_x[0,10] = row[17]  # latitude
                array_x[0,11] = row[18]  # longitude
                #array_x[0,13] = row[0]  # sale date
        ...
        #end with
        print(i)
        self.RandomSplit(self.X, self.Y, 0.3)
