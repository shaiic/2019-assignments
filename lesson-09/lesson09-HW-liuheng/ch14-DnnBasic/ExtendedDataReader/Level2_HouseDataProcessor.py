...
data_file_name = "/Volumes/D/git/ai-edu/B-教学案例与实践/B6-神经网络基本原理简明教程/Data/kc_house_data.csv"     # download from Kc
train_data_file_name = "/Volumes/D/git/ai-edu/B-教学案例与实践/B6-神经网络基本原理简明教程/Data/kc_train.csv"    # download from DC
test_data_file_name = "/Volumes/D/git/ai-edu/B-教学案例与实践/B6-神经网络基本原理简明教程/Data/kc_test.csv"      # download from DC
train_file = "/Volumes/D/git/ai-edu/B-教学案例与实践/B6-神经网络基本原理简明教程/Data/ch14.house.train.npz"
test_file = "/Volumes/D/git/ai-edu/B-教学案例与实践/B6-神经网络基本原理简明教程/Data/ch14.house.test.npz"
