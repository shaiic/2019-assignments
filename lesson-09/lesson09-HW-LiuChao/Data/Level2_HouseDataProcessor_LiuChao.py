...
data_file_name = "./kc_house_data.csv"     # download from Kc
train_data_file_name = "./kc_train.csv"    # download from DC
test_data_file_name = "./kc_test.csv"      # download from DC
train_file = "./ch14.house.train.npz"
test_file = "./ch14.house.test.npz"
